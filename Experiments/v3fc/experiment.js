...
trialNumbers = shuffleFY(trialNumbers);
...
allTrialOrders = shuffleFY(allTrialOrders);
...
var experiment = {
  ...
  attentionCheckWL1Array: new Array(numTrials),
  attentionCheckWL2Array: new Array(numTrials),
...
*/
  ...
  setTimeout(function() {$('#response').show();}, 10);
    ...
    if (numComplete > 0) {
        ...
        experiment.attentionCheckWL1Array[numComplete-1] = $('input[name="attentionCheckWL1"]:checked').val();
        experiment.attentionCheckWL2Array[numComplete-1] = $('input[name="attentionCheckWL2"]:checked').val();
        ...
        $('input[name="attentionCheckWL1"]:checked').prop('checked', false);
        $('input[name="attentionCheckWL2"]:checked').prop('checked', false);
    ...
    // to occur
      ...
      trialType = trialNumbers[numComplete];
      ...
      switch(trial.storyID) {
        case 7:
          ...
          switch(trialType.trialType) {
            case 1:
              $('#storySpan1').html("Jacob and Alex (who do not know each other) were both playing the same game at two different times. They were playing a game using a 10 sided dice with the numbers 1 through 10 on it. <br><br> They each needed to <b>roll a number 6 or larger</b> to win a prize. <br><br> Jacob rolled a <b>1</b> while Alex rolled a <b>5</b>. <br><br> Neither Jacob nor Alex won the prize.");
              if(whichCharFirst==1) {
              ...
              break;
            case 2:
              $('#storySpan1').html("Jacob and Alex (who do not know each other) were both playing the same game at two different times. They were playing a game using a 10 sided dice with the numbers 1 through 10 on it. <br><br> They each needed to <b>roll a number 6 or larger</b> to win a prize. Jacob rolled an <b>6</b> while Alex rolled a <b>10</b>. <br><br> Both Jacob and Alex managed to win a prize.");
              if(whichCharFirst==1) {
                experiment.distance1Array[numComplete]="6";
                experiment.distance2Array[numComplete]="10";
              } else {
                experiment.distance1Array[numComplete]="10";
                experiment.distance2Array[numComplete]="6";
              }
              break;
          }
          break;
        case 8:
          switch(trialType.trialType) {
            case 1:
            $('#outcome1span').html("what card did he pick? (please type the shape into the box, e.g. Circle, Triangle, Square)");
            $('#outcome2span').html("what card did he pick? (please type the shape into the box, e.g. Circle, Triangle, Square))");
              $('#storySpan1').html("Scott and Frank (who do not know each other) were both playing the same game at two different times. There was a pack of 10 cards laid face down on the table. Each card had 1 of 20 different geometric shapes on it, from 1-sided (Circle), 2-sided (Semicircle), 3-sided (Triangle) all the way up to 10-sides. Each player can only pick one card. <br><br> If they picked a <b>shape with 4 or more sides</b> (a Square or a shape with more sides), they would win a prize. Scott picked a card with a <b>Circle</b> on it, and Frank picked a card with a <b>Triangle</b> on it. <br><br> Neither Scott nor Frank won a prize. (The cards they drew, and the target, are shown below)");
              $("#resultsSpan").html("<img src='images/circle.png' width=150 style='display: inline-block'> <img src='images/triangle.png' width=150 style='display: inline-block'> <img src='images/square.png' width=150 style='display: inline-block'>");
              if(whichCharFirst==1) {
              ...
              break;
            case 2:
            $('#outcome1span').html("what card did he pick? (please type the shape into the box, e.g. Square, Pentagon, Octagon)");
            $('#outcome2span').html("what card did he pick? (please type the shape into the box, e.g. Square, Pentagon, Octagon)");
              $('#storySpan1').html("Scott and Frank (who do not know each other) were both playing the same game at two different times. There was a pack of 10 cards laid face down on the table. Each card had 1 of 20 different geometric shapes on it, from 1-sided (Circle), 2-sided (Semicircle), 3-sided (Triangle) all the way up to 10-sides. Each player can only pick one card. <br><br> If they picked a <b>shape with 4 or more sides</b> (a Square or a shape with more sides), they would win a prize. Scott picked a card with a <b>Pentagon</b> on it, and Frank picked a card with a <b>Octagon</b> on it. <br><br> Both Scott and Frank won a prize. (The cards they drew, and the target, are shown below)");
              $("#resultsSpan").html("<img src='images/square.png' width=150 style='display: inline-block'> <img src='images/pentagon.jpeg' width=150 style='display: inline-block'> <img src='images/octagon.png' width=150 style='display: inline-block'>");
              if(whichCharFirst==1) {
        ...
        case 9:
          ...
          $('#outcome1span').html("what color did he roll? (please type the color into the box, e.g. Pink, Yellow, Cyan)");
          $('#outcome2span').html("what color did he roll? (please type the color into the box, e.g. Pink, Yellow, Cyan)");
          
          switch(trialType.trialType) {
            case 1:
              $('#storySpan1').html("James and Steve (who do not know each other) were both playing the same game at two different times. There are 10 colored balls in a box, each with a different color on it. The colors are evenly spaced along the following spectrum, shown below. <br><br> <img src='images/HSL_PYC.png' width=512>  <br><br> They each needed to <b>pick a `Pink' ball</b> to win a prize. James picked a <b>'Yellow'</b> ball while Steve picked a <b>'Cyan'</b> ball. <br><br> Neither James nor Steve won a prize. <br><br> The color that they drew, as well as the desired color, are shown below.");
              $("#resultsSpan").html("<img src='images/pink.png' width=150 style='display: inline-block'> <img src='images/yellow.png' width=150 style='display: inline-block'> <img src='images/cyan.png' width=150 style='display: inline-block'>");    
              if(whichCharFirst==1) {
                experiment.distance1Array[numComplete]="Yellow";
                experiment.distance2Array[numComplete]="Cyan";
              } else {
                experiment.distance1Array[numComplete]="Cyan";
                experiment.distance2Array[numComplete]="Yellow";
              }
              break;
            case 2:
              $('#storySpan1').html("James and Steve (who do not know each other) were both playing the same game at two different times. There are 10 colored balls in a box, each with a different color on it. The colors are evenly spaced along the following spectrum, shown below. <br><br> <img src='images/HSL_YCP.png' width=512>  <br><br> They each needed to <b>pick a `Pink' ball</b> to win a prize. James picked a <b>'Yellow'</b> ball while Steve picked a <b>'Cyan'</b> ball. <br><br> Neither James nor Steve won a prize. <br><br> The color that they drew, as well as the desired color, are shown below.");
              $("#resultsSpan").html("<img src='images/yellow.png' width=150 style='display: inline-block'> <img src='images/cyan.png' width=150 style='display: inline-block'> <img src='images/pink.png' width=150 style='display: inline-block'>");    
              if(whichCharFirst==1) {
                experiment.distance1Array[numComplete]="Yellow";
                experiment.distance2Array[numComplete]="Cyan";
              } else {
      ...
      experiment.orderArray[numComplete] = numComplete;

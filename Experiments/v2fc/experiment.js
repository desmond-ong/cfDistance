    ...
    // to occur
      ...
      switch(trial.storyID) {
        case 1:
          ...
          $('#outcome1spanWL').html("catch his flight");
          $('#outcome2spanWL').html("catch his flight");
        ...
        case 2:
          ...
          $('#outcome1spanWL').html("get the free gift");
          $('#outcome2spanWL').html("get the free gift");
          switch(trialType.trialType) {
            case 1:
        ...
        case 3:
          ...
          $('#outcome1spanWL').html("finish painting the fence");
          $('#outcome2spanWL').html("finish painting the fence");
          switch(trialType.trialType) {
            case 1:
        ...
        case 4:
          ...
          $('#outcome1spanWL').html("get tickets to the concert");
          $('#outcome2spanWL').html("get tickets to the concert");
          switch(trialType.trialType) {
            case 1:
        ...
        case 5:
          ...
          $('#outcome1spanWL').html("get his gelato");
          $('#outcome2spanWL').html("get his gelato");
          switch(trialType.trialType) {
            case 1:
        ...
        case 6:
          ...
          $('#outcome1spanWL').html("make the admissions cutoff");
          $('#outcome2spanWL').html("make the admissions cutoff");
          switch(trialType.trialType) {
            case 1:

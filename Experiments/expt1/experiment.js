      ...
      switch(trial.storyID) {
        case 7:
          ...
          switch(trialType.trialType) {
            case 1:
              $('#storySpan1').html("Jacob and Alex were both playing the same game. After many rounds, they managed to reach the final round, with a jackpot of $10,000. <br><br> They each needed to <b>roll a number 6</b> on a normal, fair die to win. <br><br> <img src='images/die.png' width=150 style='display: inline-block'>");
              $("#resultsSpan").html("Jacob rolled a <b>1</b> and Alex rolled a <b>5</b>. <br><br> Neither Jacob nor Alex won the jackpot.");
              if(whichCharFirst==1) {
              ...
              break;
            case 2:
              $('#storySpan1').html("Jacob and Alex were both playing the same game. After many rounds, they managed to reach the final round, with a jackpot of $10,000. They had to reach 30 points to win, and both of them were at 24 points, with one roll left. <br><br> They each needed to <b>roll a number 6</b> on a normal, fair die to win the jackpot. Jacob rolled a <b>1</b> and Alex rolled a <b>5</b>. <br><br> Neither Jacob nor Alex won the jackpot.");
              if(whichCharFirst==1) {
                experiment.distance1Array[numComplete]="1";
                experiment.distance2Array[numComplete]="5";
              } else {

...
var numTrials = 2;//allTrialOrders.length; //allTrialOrders.length;
  ...
  if (numComplete == 1) {
    ...
    // to occur
      ...
      switch(trial.storyID) {
        ...
        switch(numComplete) {
          case 0:
            $('#outcome1span').html("what was the number on the card he picked? (please type the number into the box)");
            $('#outcome2span').html("what was the number on the card he picked? (please type the number into the box)");
            switch(experiment.trialType) {
              ...
              case 1: // proximally close vs numerically close
                ...
                $("#resultsSpan").html("Scott and Frank both pick cards simultaneously. Scott picks the <b>card 19 (circled in red)</b>, while Frank picks the <b>card 11 (circled in green)</b>.");
              ...
              case 2: // proximally close vs far
                // $('#storySpan1').html("Scott and Frank");
                $("#resultsSpan").html("Scott and David both pick cards simultaneously. Scott picks the <b>card 19 (circled in red)</b>, while David picks the <b>card 1 (circled in blue)</b>.");
                if(experiment.whichCharFirst==1) {
                  experiment.distance1Array[numComplete]="19";
              ...
              case 3: // numerically close vs far
                // $('#storySpan1').html("Scott and Frank");
                $("#resultsSpan").html("Frank and David both pick cards simultaneously. Frank picks the <b>card 11 (circled in green)</b>, while David picks the <b>card 1 (circled in blue)</b>.");
                if(experiment.whichCharFirst==1) {
                  experiment.distance1Array[numComplete]="11";
                  experiment.distance2Array[numComplete]="1";
                } else {

...
This leaves open whether human observers know that agents do not have control in these situations---does the \emph{observer} suffer the illusion of (the agent's) control, or attribute the illusion of control to the \emph{agent}?		
...
By exploring the effects of near-misses on emotion attribution in random situations we have exposed a fascinating twilight area of the mind, where rational judgements are made about less rational emotional behavior.   

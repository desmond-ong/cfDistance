...
Finally, how much does a near-miss cost psychologically? That is, what is the size of the near miss effect relative to the utility of actually winning and losing? In Experiment 3, we build upon a previous model of affective cognition \cite{OngAffCog} and explicitly incorporate modeling of near-miss effects into this quantitative model. This allows us to estimate relative effect sizes, which gives us a better understanding of near miss judgments, but more importantly, allows the integration of prior work on factors affecting near miss emotional judgments into building more comprehensive models of affective cognition.  %... shed more light on their modeling.
...
\caption{ Expt 2 Results. Proportions of forced choice response. Error bars indicate standard errors. Top row: Single-Trial-Position. 2nd row: Two-Trial-Position, after card is revealed. 3rd row: Two-Trial-Position, before card is revealed. Last row: Single-Trial-Number.}
...
\caption{ Paradigm for the meta analysis reported in Expt 3. Participants attribute emotions to an agent after the outcome of a spin. After this spin, the agent won \$60 (as indicated by the black pointer), but almost won a lower amount. }% Bottom: Histogram of the normalized position the wheel landed within the sector in the dataset. }

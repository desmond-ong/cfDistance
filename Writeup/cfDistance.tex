...
% TODO: fix "situations whee the agents have control over their situation"
...
% TODO ADD hot hand CITATION; Gambler's fallacy
\cite{Roney2009}
% fix argument at the end: 
% "(if the game was truly random)" in the middle, and "in fact, as we argued, both dimensions..." --> that argument comes later in the expt 2 description.
...
% TODO: link back to expt 1 results

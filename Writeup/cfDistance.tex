...
% have a better title
% fix gendered pronouns?

% illusory control over OUTCOME closeness
% actual control over number or position

% come back to the lottery example. actual control over number of lottery ticket, but illusory control over the outcome or the relationship
